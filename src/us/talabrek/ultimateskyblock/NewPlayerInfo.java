...
public class UUIDPlayerInfo implements Serializable {
  ...
  public void setupPlayer(String player) {
    ...
    FileConfiguration.createPath(getPlayerConfig(player).getConfigurationSection("player"), "hasIsland");
    getPlayerConfig(player);
    FileConfiguration.createPath(getPlayerConfig(player).getConfigurationSection("player"), "islandX");
    getPlayerConfig(player);
    FileConfiguration.createPath(getPlayerConfig(player).getConfigurationSection("player"), "islandY");
    getPlayerConfig(player);
    FileConfiguration.createPath(getPlayerConfig(player).getConfigurationSection("player"), "islandZ");
    getPlayerConfig(player);
    FileConfiguration.createPath(getPlayerConfig(player).getConfigurationSection("player"), "homeX");
    getPlayerConfig(player);
    FileConfiguration.createPath(getPlayerConfig(player).getConfigurationSection("player"), "homeY");
    getPlayerConfig(player);
    FileConfiguration.createPath(getPlayerConfig(player).getConfigurationSection("player"), "homeZ");
    getPlayerConfig(player);
    FileConfiguration.createPath(getPlayerConfig(player).getConfigurationSection("player"), "challenges");
    ...
    while (ent.hasNext()) {
      ...
      getPlayerConfig(player);
      FileConfiguration.createPath(getPlayerConfig(player).getConfigurationSection("player.challenges." + currentChallenge), "firstCompleted");
      getPlayerConfig(player);
      FileConfiguration.createPath(getPlayerConfig(player).getConfigurationSection("player.challenges." + currentChallenge), "timesCompleted");
      getPlayerConfig(player);
      FileConfiguration.createPath(getPlayerConfig(player).getConfigurationSection("player.challenges." + currentChallenge), "timesCompletedSinceTimer");
  ...
  public PlayerInfo loadPlayer(final UUID playerUUID) {
    this.playerUUID = playerUUID;
